...
CATEGORY_KEYWORDS = {
    ExpenseCategory.UTILITIES: [
        "eletricidade", "electricidade", "luz", "energia", "água", "agua",
        "gás", "gas", "saneamento", "resíduos", "lixo",
    ],
    ExpenseCategory.TELECOM: [
        "internet", "telefone", "telemóvel", "telemovel", "móvel", "movel",
        "fibra", "tv", "televisão", "televisao", "cabo", "dados",
    ],
    ExpenseCategory.TRANSPORT: [
        "combustível", "combustivel", "gasolina", "gasóleo", "gasoleo",
        "portagem", "portagens", "estacionamento", "parque", "uber",
        "bolt", "táxi", "taxi", "metro", "autocarro", "comboio", "passe",
    ],
    ExpenseCategory.INSURANCE: [
        "seguro", "seguros", "apólice", "apolice", "prémio", "premio",
        "cobertura", "sinistro",
    ],
    ExpenseCategory.HEALTH: [
        "farmácia", "farmacia", "medicamento", "médico", "medico",
        "hospital", "clínica", "clinica", "consulta", "exame", "análise",
        "dentista", "oftalmologista", "saúde", "saude",
    ],
    ExpenseCategory.EDUCATION: [
        "escola", "universidade", "faculdade", "curso", "formação",
        "formacao", "livro", "propina", "matrícula", "matricula",
        "educação", "educacao", "ensino",
    ],
    ExpenseCategory.FOOD: [
        "supermercado", "mercearia", "restaurante", "café", "cafe",
        "padaria", "talho", "peixaria", "alimentação", "alimentacao",
        "continente", "pingo doce", "lidl", "aldi", "minipreço",
    ],
    ExpenseCategory.HOUSING: [
        "renda", "aluguer", "hipoteca", "condomínio", "condominio",
        "manutenção", "manutencao", "reparação", "reparacao",
        "mobília", "mobilia", "decoração", "decoracao",
    ],
    ExpenseCategory.ENTERTAINMENT: [
        "cinema", "teatro", "concerto", "spotify", "netflix", "hbo",
        "disney", "playstation", "xbox", "steam", "jogo", "bilhete",
        "lazer", "entretenimento", "diversão",
    ],
    ExpenseCategory.CLOTHING: [
        "roupa", "vestuário", "vestuario", "calçado", "calcado",
        "zara", "h&m", "primark", "mango", "bershka", "pull&bear",
    ],
    ExpenseCategory.TAXES: [
        "imposto", "irs", "irc", "imi", "iuc", "iva", "taxa",
        "finanças", "financas", "contribuição", "contribuicao",
        "segurança social", "seguranca social",
    ],
    ExpenseCategory.BANK_FEES: [
        "comissão", "comissao", "anuidade", "manutenção conta",
        "transferência", "transferencia", "juros", "descoberto",
    ],
    ExpenseCategory.SUBSCRIPTIONS: [
        "subscrição", "subscricao", "assinatura", "mensalidade",
        "plano", "premium", "membership",
    ],
}
